---
title: GraphQL API
description: Use the Probo console GraphQL API at /api/console/v1/graphql to query and mutate records, with guidance on connections, errors, and compatibility.
---
