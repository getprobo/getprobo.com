...
- A current version of [Windsurf](https://devin.ai/desktop)
...
For Windsurf-specific configuration behavior, see the [Windsurf MCP documentation](https://docs.devin.ai/desktop/cascade/mcp).
