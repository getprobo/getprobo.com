...
- If a firewall or WAF restricts inbound traffic by source IP, allowlist the [Probo Cloud egress address](/docs/deployment/ip-ranges) for the region that hosts the organization. Self-hosted Probo uses the outbound addresses of your own network.
