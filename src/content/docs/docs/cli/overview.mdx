...
1. **Authenticate with your Probo instance**
   ...
   Interactive mode lets you choose `us.probo.com`, `eu.probo.com`, or a custom hostname, then completes browser-based device authorization and optionally sets a default organization.
