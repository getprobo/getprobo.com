...
tools = [
    ...
    },
    {
        ...
        "function": {
            "name": "addThirdParty",
            "description": "Add a new third party to the organization",
            "parameters": {
                "type": "object",
                "properties": {
                    "organization_id": {
...
const tools = [
  ...
  },
  {
    ...
    function: {
      ...
      description: "List all third parties for the organization",
      parameters: {
        type: "object",
        properties: {
          organization_id: {
...
// Usage
const answer = await chat("Show me all third parties in my organization");
console.log(answer);
```
...
paths:
  ...
  /tools/addThirdParty:
    post:
      ...
      responses:
        "200":
          description: ThirdParty created successfully
...
**Description**: Manage your compliance data, risks, third parties, and audits through natural conversation.
...
You can help users:
- List and manage organizations, third parties, and people
...
"List all third parties for organization org_xxx"
...
```json
{
  ...
  "description_for_model": "Access and manage compliance data including organizations, third parties, risks, measures, frameworks, assets, data classifications, findings, obligations, and audits.",
  "auth": {
    "type": "user_http",
