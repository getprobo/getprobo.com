---
title: Windows
description: Install Probo Agent on Windows with the signed MSI and enroll from the Probo console
---
...
<CardGrid>
  ...
  <LinkCard
    title="macOS"
    description="Install with the signed package and enroll from the Probo console"
