---
title: Security
description: How Probo Agent reports posture without remote control—push-only design, fixed checks, and signed updates
---
...
<CardGrid>
  <LinkCard
    title="Overview"
    description="What the agent does and which platforms it supports"
    href="/docs/product/probo-agent/overview"
  />
  <LinkCard
    title="Commands"
    description="install, status, collect, update, and uninstall"
    href="/docs/product/probo-agent/commands"
  />
  <LinkCard
    title="macOS install"
    description="Signed package and browser enrollment"
