---
title: macOS
description: Install Probo Agent on macOS with the signed package and enroll from the Probo console
---
...
<CardGrid>
  ...
  <LinkCard
    title="Windows"
    description="Install with the signed MSI and enroll from the Probo console"
    href="/docs/product/probo-agent/windows"
  />
  <LinkCard
    title="Linux"
    description="Install and enroll on Linux with install.sh or the CLI"
