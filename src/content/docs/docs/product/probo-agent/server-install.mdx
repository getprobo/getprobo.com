---
title: Server install (Linux / FreeBSD)
description: Install and enroll Probo Agent on Linux or FreeBSD with install.sh or the CLI
---
...
For macOS or Windows desktops (installer + Probo console enroll via the tray), see [Desktop install](/docs/product/probo-agent/desktop-install).
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Install on macOS or Windows and enroll from the Probo console"
