---
title: SigNoz
description: Connect SigNoz as an access source using a service account API key
---
...
{/* Screenshot pending: save the key-creation dialog to public/docs/access-review/signoz-create-api-key.webp and restore the image line here. */}
