---
title: OpenAI
description: Connect OpenAI as an access source using an organization Admin API key
---
...
![Creating a Read only Admin key in the OpenAI API platform](/docs/access-review/openai-create-api-key.webp)
