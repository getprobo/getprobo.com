---
title: Grafana
description: Connect Grafana as an access source using a service account token
---
...
{/* Screenshot pending: save the key-creation dialog to public/docs/access-review/grafana-create-api-key.webp and restore the image line here. */}
