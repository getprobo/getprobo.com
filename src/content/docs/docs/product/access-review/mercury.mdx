---
title: Mercury
description: Connect Mercury as an access source using a Read Only API token
---
...
{/* Screenshot pending: save the key-creation dialog to public/docs/access-review/mercury-create-api-key.webp and restore the image line here. */}
