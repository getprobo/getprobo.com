...
| ----------- | -------------------------------------------------------- | -------------------------------------------------------------- |
| Name        | `first_name` and `last_name`                             | Falls back to the primary email address when no name is set    |
...
| MFA         | `two_factor_enabled`, `totp_enabled`                     | Derived from the user's two-factor or TOTP enrollment          |
