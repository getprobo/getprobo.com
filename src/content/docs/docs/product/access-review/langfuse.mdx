---
title: Langfuse
description: Connect Langfuse as an access source using an organization-scoped API key
---
...
{/* Screenshot pending: save the key-creation dialog to public/docs/access-review/langfuse-create-api-key.webp and restore the image line here. */}
