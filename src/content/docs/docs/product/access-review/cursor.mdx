...
2. Click **New API Key**, name it (e.g. `Probo Access Review`), and change its **Scope** from **Admin** to **Read-only**.
3. Create and copy the key (`crsr_…`), then store it securely. It's shown only once.
