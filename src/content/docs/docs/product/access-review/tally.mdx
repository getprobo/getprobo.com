---
title: Tally
description: Connect Tally as an access source using a Tally API key
---
...
{/* Screenshot pending: save the key-creation dialog to public/docs/access-review/tally-create-api-key.webp and restore the image line here. */}
