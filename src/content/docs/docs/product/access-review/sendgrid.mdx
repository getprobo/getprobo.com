---
title: SendGrid
description: Connect SendGrid as an access source using a SendGrid API key with Teammates access
---
...
{/* Screenshot pending: save the key-creation dialog to public/docs/access-review/sendgrid-create-api-key.webp and restore the image line here. */}
