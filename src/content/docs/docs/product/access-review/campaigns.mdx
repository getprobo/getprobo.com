...
description: Follow the console workflow for an access review campaign, from creating it through reviewing accounts, applying flags, and recording decisions.
---
...
1. In Probo, open your organization and go to **Access Review** > **Campaigns**.
