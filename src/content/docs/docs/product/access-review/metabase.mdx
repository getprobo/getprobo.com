---
title: Metabase
description: Connect Metabase as an access source using an Administrators group API key
---
...
{/* Screenshot pending: save the key-creation dialog to public/docs/access-review/metabase-create-api-key.webp and restore the image line here. */}
