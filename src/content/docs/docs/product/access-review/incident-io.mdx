---
title: incident.io
description: Connect incident.io as an access source using an API key
---
...
{/* Screenshot pending: save the key-creation dialog to public/docs/access-review/incident-io-create-api-key.webp and restore the image line here. */}
