---
title: Neon
description: Connect Neon as an access source using an organization API key
---
...
{/* Screenshot pending: save the key-creation dialog to public/docs/access-review/neon-create-api-key.webp and restore the image line here. */}
