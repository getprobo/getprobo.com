...
3. In Probo, go to **Access Review** > **Connections** and find **Calendly**. Click **API Key** on that row. When your deployment also offers OAuth, **API Key** sits in the menu behind the arrow next to the **OAuth** button.
