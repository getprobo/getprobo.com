...
3. In Probo, go to **Access Reviews** > **Connections** and find **Cal.com**. Click **API Key** on that row. When your deployment also offers OAuth, **API Key** sits in the menu behind the arrow next to the **OAuth** button.
