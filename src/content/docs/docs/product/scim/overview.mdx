...
description: Learn how Probo's SCIM provisioning works, comparing push-based direct provisioning with pull-based Bridge synchronization, tokens, and events.
---
