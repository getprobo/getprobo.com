...
description: Understand SAML authentication, domain verification, and enforcement in Probo
---
...
SSO authenticates a person; it does not provision or remove memberships. Use [SCIM](/docs/product/scim/overview) for lifecycle automation.
