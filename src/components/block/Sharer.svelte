<script lang="ts">
  ...
  const {
    ...
    class: className,
    gap = 6,
  }: { url: string; title: string; class?: string; gap?: number } = $props();
...
<aside class={clsx("text-center flex flex-col gap-4 items-center", className)}>
  ...
  >
    ...
    >
      ...
      >
        <path
          d="M10.4898 7.62738L17.0515 0H15.4966L9.79908 6.62275L5.24853 0H0L6.88133 10.0148L0 18.0132H1.55499L7.57167 11.0194L12.3774 18.0132H17.6259L10.4898 7.62738ZM8.36005 10.103L7.66282 9.10575L2.11527 1.17057H4.50364L8.98058 7.57452L9.6778 8.57176L15.4973 16.8959H13.1089L8.36005 10.103Z"
          fill="currentColor"
        />
      </svg>
    </button>
    ...
    >
      ...
      >
        <path
          fill="currentColor"
          d="m0 1.88 8 4 8-4A2 2 0 0 0 14 0H2a2 2 0 0 0-2 1.88Z"
        />
        <path
          fill="currentColor"
          d="m16 4.12-8 4-8-4V10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4.12Z"
        />
      </svg>
    </button>
    <button
