  ...
  return (
    <footer className="bg-dark-900 grid gap-20 rounded-tl-3xl rounded-tr-3xl px-5 py-20">
      ...
      <div className="grid gap-12 md:grid-cols-2 md:gap-0">
        ...
        <div className="text-dark-400 grid gap-6 text-base leading-normal font-normal md:mr-30 md:grid-flow-col md:grid-cols-2 md:grid-rows-4 md:justify-self-end">
          <Link href="/">Home</Link>
